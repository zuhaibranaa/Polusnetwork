    ...
    >
        <div class="rounded-t bg-white mb-0 px-6 py-6">
            <div class="text-center flex justify-between">
                <h6 class="text-purple-700 text-xl font-bold">My account</h6>
                <button
        ...
        <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
            <form>
                <h6
                    class="text-purple-400 text-sm mt-3 mb-6 font-bold uppercase"
                >
                    User Information
                </h6>
                ...
                <hr class="mt-6 border-b-1 border-purple-300" />
