<template>
    <div>
        <a
            class="hover:text-purple-500 text-purple-700 px-3 py-2 flex items-center text-xs uppercase font-bold"
            ref="btnDropdownRef"
        ...
        >
            <span
                class="text-sm pt-2 pb-0 px-4 font-bold block w-full whitespace-nowrap bg-transparent text-purple-400"
            >
                Actions
            </span>
            <router-link
